...
## You Did It! {.center background-color="#1a1a2e" data-state="confetti"}

::: {.r-fit-text}
Congratulations
:::

Four weeks. Four skills. Real data science.

**Descriptives → T-tests → ANOVA → Regression**

You can now take a research question all the way from raw data to a published result.
  ...
  s.onload = function() {
    if (typeof Reveal !== 'undefined') {
      Reveal.on('slidechanged', function(e) {
        if (e.currentSlide.dataset.state === 'confetti') {
